...
\begin{figure}
  ...
  \caption{ We fit 50 layers tightly around \emph{Max Planck}'s head (top
  left).}
...
\begin{figure}
  ...
  \caption{\newhl{Depending on the target application, our method can generate cages that are homeomorphic to the input mesh (center) or with some handles removed (right).}}
  \label{fig:elephants}
\end{figure}
