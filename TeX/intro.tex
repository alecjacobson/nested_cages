...
\begin{figure}[b]
  ...
  is large: 25 around this \emph{Horse}. \alec{no ref in new intro text}}
...
\centering
%
\includegraphics[trim=0 0 0 3mm,width=\linewidth]{figs/boxer-cages-not-cages}
%
\end{wrapfigure}
%
...
that nests $\Fout$ (see \reffig{torus-counterexample}). In fact in 3D the decision
problem of whether any nesting of $\Cinp$ around $\Fout$ exists is at least as hard
as the graph isomorphism problem\alec{ (see Appendix for a reduction)}.
