...
(e.g.\ box, KDOP, convex hull), perhaps also ``shrink-wrapping'' it around
$\Finp$ to minimize $E$. This approach works well for convex $\Finp$, but will
not give a good fit for meshes with nooks and concavities. It is also not clear
how to find a bounding polytope for meshes of nontrivial topology.
%
...
parameter. Though the \emph{continuous} isosurface may not intersect the input
model, generic contouring invalidates this. A large enough iso-value or
...
\alec{Should we include any of this:}
