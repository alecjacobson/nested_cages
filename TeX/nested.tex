...
\begin{CRcatlist}
  \CRcat{I.3.0}{Computer Graphics}{}{}
  %\CRcat{I.3.5}{Computer Graphics}{Computational Geometry and Object Modeling}{}
  %\CRcat{G.1.8}{Numerical Analysis}{Partial Differential Equations}{Multigrid and multilevel methods}
\end{CRcatlist}
