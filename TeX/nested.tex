...
\teaser{
  \includegraphics[width=\textwidth]{\figs/bunny-teaser}
  \caption{
Given an input shape (far left), our method constructs \emph{nested} cages:
each subsequent mesh is coarser than the last and fully encloses it with
intersections. A slice through all layers (far right), shows a tightly
encaged \emph{Bunny}.}
  \label{fig:teaser}  
}
