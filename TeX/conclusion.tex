...
\newhl{We believe the performance of our multiresolution solver could be further
...
\newhl{Our cages are designed for \emph{volumetric} multiresolution solvers, and are not} immediately applicable to \emph{surface-based} multiresolution problems
