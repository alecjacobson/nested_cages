...
\begin{figure}[t]
  \vspace{-0.1cm}
  \includegraphics[trim=0mm 0mm 0mm 8mm,width=\linewidth]{figs/bunny-shelf-teaser} 
  \vspace*{-2em}
...
%and in Figure~\ref{fig:swat} we show a single cage result. 
Examples of these resolution take on the order of minutes to generate. 
%The input \emph{S.W.A.T. man} mesh has a lot
