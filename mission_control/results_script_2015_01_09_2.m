...
[V0,F0] = load_mesh('/Users/leokollersacht/Documents/nested_cages/Meshes/Results/raptor-2M/raptor-500K.ply');
V0 = V0/max(max(abs(V0)));
levels = floor(2.^((-22:2:-2)/3)*size(F0,1));
[cages_V,cages_F,~,~,~,timing] = ...
  multires_per_layer( ...
  ...
  'EpsFinal',1e-3,...
  'PartialPath','partial_01_09_02.mat');
write_cages('/Users/leokollersacht/Documents/nested_cages/Meshes/Results/raptor-500K_disppath/raptor-500K',cages_V,cages_F);
save('/Users/leokollersacht/Documents/nested_cages/Meshes/Results/raptor-500K_disppath/timing.mat','timing')
% Obs.: Trying displacement_path on the other window.
% Trying volume here