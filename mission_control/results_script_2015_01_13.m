...
% [V0,F0] = load_mesh('/Users/Leo/PHD_Work/Cage_Generation_2013/models/maxplank-R13k.off');
% V0 = V0/max(max(abs(V0)));
...
%   'EpsFinal',5e-4,...
%   'PartialPath','partial_01_13.mat');
% write_cages('../../Meshes/Results/maxplank-volume_final/maxplank',cages_V,cages_F);
% save('../../Meshes/Results/maxplank-volume_final/timing.mat','timing')
% % Obs.: 
% 
% [V0,F0] = load_mesh('/Users/Leo/PHD_Work/Cage_Generation_2013/models/maxplank-R13k.off');
% V0 = V0/max(max(abs(V0)));
...
%   'EpsFinal',1e-3,...
%   'PartialPath','partial_01_13.mat');
% write_cages('../../Meshes/Results/maxplank-varap_final/maxplank',cages_V,cages_F);
% save('../../Meshes/Results/maxplank-varap_final/timing.mat','timing')
% % Obs.: 
% 
% [V0,F0] = load_mesh('/Users/Leo/PHD_Work/Cage_Generation_2013/models/maxplank-R13k.off');
% V0 = V0/max(max(abs(V0)));
...
%   'EpsFinal',1e-3,...
%   'PartialPath','partial_01_13.mat');
% write_cages('../../Meshes/Results/maxplank-arap_final/maxplank',cages_V,cages_F);
% save('../../Meshes/Results/maxplank-arap_final/timing.mat','timing')
% % Obs.: 