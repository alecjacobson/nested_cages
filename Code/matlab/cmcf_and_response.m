function U = cmcf_and_response(V,F,varargin)
  % cmcf_and_response Flow a surface according to "Can mean
  % curvature flow be made non-singular?" [Kazhdan et al. 2012] and
  % remove collisions using Eltopo.
  % Obs.: Here we do not renormalize the surface
  %
  % Inputs:
