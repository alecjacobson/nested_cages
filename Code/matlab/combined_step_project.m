function [V_coarse_final,timing,Pall_expansion] = ...
  ...
  params_to_variables = containers.Map( ...
    {  'SkipElTopo','ExpansionEnergy','FinalEnergy','EpsExpansion','EpsFinal','BetaInit','Debug','Fquad','D_CV_MIN','RefCage','BETA_MIN'}, ...
    {'skip_el_topo','energy_expansion','energy_final','eps_distance_expansion','eps_distance_final','beta_init','debug','Fquad','D_CV_MIN','CV_ref','BETA_MIN'});
  v = 1;
  ...
  for t = k-1:-1:1
    ...
    V = P_all(:,:,t);
        [CV_filtered,timing.per_step{k-t}] = one_step_project( ...
          ...
          'Tol',tol_dt,'PlotInfo',plot_info,'Debug',debug,'D_CV_MIN',D_CV_MIN,'BETA_MIN',BETA_MIN);
