function [V_coarse_final,timing,Pall_expansion] = ...
  ...
  params_to_variables = containers.Map( ...
    {  'SkipElTopo','ExpansionEnergy','FinalEnergy','Eps','EpsExpansion','BetaInit','Debug','Fquad','D_CV_MIN','RefCage'}, ...
    {'skip_el_topo','energy_expansion','energy_final','eps_distance','eps_distance_expansion','beta_init','debug','Fquad','D_CV_MIN','CV_ref'});
  v = 1;
  ...
  if ~strcmp(energy_final,'none')
    ...
    [CV_filtered,timing.per_step{k}] = ...
      one_step_project( ...
        ...
        energy_gradient,energy_value,cb_data, ...
        'SkipElTopo',skip_el_topo, ...
        'BetaInit',beta,'Eps',eps_distance, ...
        'Tol',tol_dt,'PlotInfo',plot_info,'Debug',debug,'D_CV_MIN',D_CV_MIN);
