function [V_coarse_final,timing,Pall_expansion] = ...
  ...
  params_to_variables = containers.Map( ...
    {  'SkipElTopo','ExpansionEnergy','FinalEnergy','EpsExpansion','EpsFinal','BetaInit','Debug','Fquad','D_CV_MIN','RefCage'}, ...
    {'skip_el_topo','energy_expansion','energy_final','eps_distance_expansion','eps_distance_final','beta_init','debug','Fquad','D_CV_MIN','CV_ref'});
  v = 1;
